...
export function activate(context: vscode.ExtensionContext) {
	...
	vscode.window.createTreeView('nextjs-route', {
		treeDataProvider: new NextJsRouteView(rootPath as string)
	});
	...
	let disposable = vscode.commands.registerCommand('nextjs-extension.hello-world', () => {
		// The code you place here will be executed every time your command is executed
		// Display a message box to the user
		vscode.window.showInformationMessage("Hello world", "Super", "Hyper");
	});
